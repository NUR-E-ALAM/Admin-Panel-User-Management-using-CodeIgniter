...
LARAGON : F:\laragon\www\Admin-Panel-User-Management-using-CodeIgniter

OR

**WAMP : c:/wamp/www/Admin-Panel-User-Management-using-CodeIgnitercia**

OR

**XAMPP : c:/xampp/htdocs/Admin-Panel-User-Management-using-CodeIgnitercia**

Open browser; goto [localhost/](http://localhost/cias)codeigniter-admin and press enter:
